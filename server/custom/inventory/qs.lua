...
sv_inventory.imagePath = 'nui://qs-inventory/html/images/' -- Path to the NUI images, don't change unless web path was moved
...
function sv_inventory:formatItemList()
    ...
    for _, v in pairs(itemList) do
        if not v or not v.name then
            Debug('Item not found in itemList:', v)
            goto continue
        end
